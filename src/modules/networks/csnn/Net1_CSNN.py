...
class Net1_CSNN(nn.Module):
    def __init__(self, num_inputs, num_outputs, betas, spike_grad, num_steps, thresholds):
        ...
        # Architecture
        self.architecture = "Conv1d(1, 16, 5) + MaxPool(2) + LIF + Conv1d(16, 64, 5) + MaxPool(2) + LIF + Linear(256, 2) + LIF"
        # Layer1
        ...
        self.lif3 = snn.Leaky(beta=self.betas[2], spike_grad=spike_grad, threshold=self.thresholds[2], learn_beta=True, learn_threshold=True, output=True)
