...
class Net3_CSNN(nn.Module):
    def __init__(self, num_inputs, num_outputs, betas, spike_grad, num_steps, thresholds):
        ...
        # Architecture
        self.architecture = "Conv1d(1, 8, 3) + MaxPool(2) + LIF  + Conv1d(8, 16, 3) + MaxPool(2) + LIF  + Conv1d(16, 48, 3) + MaxPool(2) + LIF + Linear(92, 2) + LIF"
        # Layer1
